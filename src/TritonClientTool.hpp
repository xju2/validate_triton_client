...
class TritonClientTool {
  public:
    TritonClientTool(const std::string& modelName,
    ...
    TritonClientTool() = delete;
    TritonClientTool(const TritonClientTool&) = delete;
    TritonClientTool& operator=(const TritonClientTool&) = delete;
    ~TritonClientTool() {};
